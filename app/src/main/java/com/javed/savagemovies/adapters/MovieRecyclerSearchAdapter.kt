...
import com.javed.savagemovies.databinding.MovieListSearchBinding
import com.javed.savagemovies.modelclasses.MoviesResponses
import com.javed.savagemovies.ui.MovieDetailActivity
import com.squareup.picasso.Picasso

class MovieRecyclerSearchAdapter() :
    ListAdapter<MoviesResponses, MovieRecyclerSearchAdapter.RecyclerAdapterViewHolder>(DiffUtil()) {
    lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerAdapterViewHolder {
        val binding =
            MovieListSearchBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class RecyclerAdapterViewHolder(
        private val binding: MovieListSearchBinding,
        val context: Context
    ) :
        ...
        fun bind(moviesResponses: MoviesResponses) {
            binding.apply {
                ...
                if (moviesResponses.show.image.medium != null) {
